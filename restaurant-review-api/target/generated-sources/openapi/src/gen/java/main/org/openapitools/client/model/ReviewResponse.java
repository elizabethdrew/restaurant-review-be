...
public class ReviewResponse {
  ...
  **/
  ...
  public ReviewResponse restaurant(Review restaurant) {
  ...
  **/
  ...
  public void setRestaurant(Review restaurant) {
    this.restaurant = restaurant;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.success, reviewResponse.success) &&
        Objects.equals(this.restaurant, reviewResponse.restaurant) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReviewResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReviewResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ReviewResponse.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ReviewResponse` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      // validate the optional field `restaurant`
      if (jsonObj.get("restaurant") != null && !jsonObj.get("restaurant").isJsonNull()) {
        Review.validateJsonObject(jsonObj.getAsJsonObject("restaurant"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReviewResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReviewResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReviewResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReviewResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ReviewResponse>() {
           @Override
           public void write(JsonWriter out, ReviewResponse value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ReviewResponse read(JsonReader in) throws IOException {
