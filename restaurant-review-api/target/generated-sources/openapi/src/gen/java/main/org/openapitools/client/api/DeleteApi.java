...
public class DeleteApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 204 </td><td> Review deleted </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Review not found </td><td>  -  </td></tr>
        <tr><td> 500 </td><td> Internal server error </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteReviewByIDCall(Integer reviewId, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteReviewByIDValidateBeforeCall(Integer reviewId, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'reviewId' is set
        if (reviewId == null) {
            throw new ApiException("Missing the required parameter 'reviewId' when calling deleteReviewByID(Async)");
        }

        return deleteReviewByIDCall(reviewId, _callback);
     ...
     */
    public void deleteReviewByID(Integer reviewId) throws ApiException {
        deleteReviewByIDWithHttpInfo(reviewId);
    }
     ...
     */
    public ApiResponse<Void> deleteReviewByIDWithHttpInfo(Integer reviewId) throws ApiException {
        okhttp3.Call localVarCall = deleteReviewByIDValidateBeforeCall(reviewId, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call deleteReviewByIDAsync(Integer reviewId, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteReviewByIDValidateBeforeCall(reviewId, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
    /**
