...
public class JwtService {
    ...
    public String generateToken(SecurityUser securityUser) { //might need to use securityuser?
        return generateToken(new HashMap<>(), securityUser);
    }

    public String generateToken(Map<String, Object> extractClaims, SecurityUser securityUser) { //might need to use securityuser?
        return Jwts
                .builder()
