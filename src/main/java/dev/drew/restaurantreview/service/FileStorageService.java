...
public class FileStorageService {
    ...
    public String uploadFile(String type, Integer itemId, MultipartFile file, String bucketName) {
        ...
        try {
            ...
            if (response != null) {
                ...
                return "http://" + bucketName + ".s3.localhost.localstack.cloud:4566/" + objectKey;
            } else {
